            ...
            <Card>
              <Link href={`/projects/${featured.slug}`}>
                <article className="relative w-full h-full p-4 md:p-8">
                  ...
                  <h2 className="mt-4 text-xl font-medium duration-1000 lg:text-2xl text-zinc-200 group-hover:text-white font-display">
                    {featured.title}
                  </h2>
                  <p className="mt-4 text-sm duration-1000 text-zinc-400 group-hover:text-zinc-300 line-clamp-3">
